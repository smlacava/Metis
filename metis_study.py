...
class metis_study():
    ...
    def groups_comparison(self, first_data, second_data=None, first_labels=None,
                          second_labels=None, distance=euclidean_distance(), threshold=None,
                          view_analysis=False, generate_pdf=False,
                          first_name="first", second_name="second", bins=None,
                          report_name="report.pdf",
                          features_selection_algorithm=None,
                          selected_features=None, biometric_analysis=True, statistical_analysis=True,
                          permutation_test=True, permutation_method='approximate', permutation_assumption='different'):
        """
    ...
    def data_analysis(self, data, labels=None, distance=euclidean_distance(), threshold=None,
                      view_analysis=False, generate_pdf=False, name="first",
                      bins=None, report_name="report.pdf",
                      features_selection_algorithm=None,
                      selected_features=None, biometric_analysis=True):
        """
        The groups_comparison method computes an analysis between two groups, represented as two different 3D
        (subjects*repetitions*features) data matrices or 2D (subjects*features) data matrices (in this case the labels
        related to each file is also required), eventually reporting it on a pdf file.
        ...
        self._report_generator.single_analysis(self._data_manager, self._statan,
                                               ...
                                               data, labels, self.distance, threshold,
